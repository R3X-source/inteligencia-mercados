...
// ESTE ES EL LINK: Si el de Discord falla porque caduca, usa uno de Catbox.moe que es eterno.
const LINK_VIDEO = "https://cdn.discordapp.com/attachments/1240674500622680094/1475913222115561665/TikVid.io_7591558082040171799.mp4";
...
client.on('ready', () => {
    console.log(`✅ Ready! Usando link directo.`);
});
...
client.on('messageCreate', async (msg) => {
    ...
    // Lógica usuaria sin ping (0.1s espera)
    ...
    // Lógica objetivos con pausa aleatoria cada 10s
