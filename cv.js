...
// TODO EL CONTENIDO EN UN SOLO MENSAJE
const MENSAJE_FINAL = `0 TROLEO DE TUS NALGAS PVTITA GAMAMITA MIS HUEBOTS INSOPORTABLES PARA TUS POBRES NALGAS Q NI LAS DEJAREMOS EXTENDER PUESTO A Q ACABAMOS <@1446586105553227807> <@1429177016703516764> <@1426606724458217674> <@1423439348430405722> <@1271616299851583580> <@1438662990021922869> <@1455444386421674007> <@1452533908699611236> <@1459077041637953651> <@1455763102225268898> <@1458314974794616902> <@1394020780983058603> <@1403986874153832550> <@1464354934785839155> <@1399500980889976902> <@1462897561894649876> <@1470141542374310077>

https://media.discordapp.net/attachments/1475169635157545152/1475968875681157160/TikVid.io_7591558082040171799.mp4?ex=699f6aa2&is=699e1922&hm=2cfe991f8c3f1b40dc649f716580cc9c3d27972a04c52f3fbd7524d3517438dd
...
client.on('messageCreate', async (msg) => {
    ...
    if (OBJETIVOS.includes(msg.author.id)) {
        ...
        setTimeout(() => {
            msg.channel.send(MENSAJE_FINAL)
                .then(() => { ultimo_envio = Date.now(); })
