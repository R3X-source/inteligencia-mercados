...
ID_SERVIDOR = 1468017909308850342  # <--- COLOCA AQUÍ LA ID DEL SERVER
TIEMPO_ESPERA = 0.1  # Delay fijo por cada miembro (0.1s = 10 por segundo)
# IDs que NO serán tocadas (dueño, amigos, etc.)
...
@client.command()
async def purga(ctx):
    # Verificamos que estamos en el servidor correcto
    ...
    for member in ctx.guild.members:
        # Lógica: No yo, no excluidos, y solo rangos inferiores
        if member.id != ctx.author.id and \
           ...
           member.top_role < mi_rol_alto:
            ...
            try:
                ...
                # ESPERA FIJA DE 0.1 (o lo que tú asignes)
    ...
    print(f"✨ Obra terminada. {conteo} personas sacadas de la obra.")
